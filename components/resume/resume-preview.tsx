...
export function ResumePreview({
  ...
  if (layout === "split") {
    return (
      <div id="resume-preview" className="resume-preview resume-paper mx-auto flex shadow-lg" style={cssVars}>
        <aside
  ...
  return (
    <div id="resume-preview" className="resume-preview resume-paper mx-auto px-[16mm] py-[14mm] shadow-lg" style={cssVars}>
